...
use Modules\Media\Http\Controllers\VideoEditor\BaseControllerClass as BaseController;
...
class VideoEditor extends Component {
    ...
    public function render() {
        ...
        $config_component = FileService::config('media::videoeditor');
        ...
        */
        ...
        $included_template = 'media::components.video-editor.custom.templates.'.$action.'_templates';
