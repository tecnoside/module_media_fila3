...
namespace Modules\Media\Http\Livewire\VideoEditorSub;
...
class Model extends Component {
    ...
    public function updateCurrentTime(float $currentTime) {
...
//        }
    ...
    public function render() {
        return view('media::livewire.video-editor-sub.model');
    }
