    ...
    <div class="flex flex-col-reverse mb-10 lg:flex-row lg:mb-24">
        <div class="mt-8">
            ...
            <div class="flex my-10">
                <?php ($first=$docs->where('id',6)->first()); ?>
                <a href="<?php echo e(url($first->getPath())); ?>" title="<?php echo e($first->title); ?> getting started" class="bg-blue-500 hover:bg-blue-600 font-normal text-white hover:text-white rounded mr-4 py-2 px-6"><?php echo e($first->title); ?></a>
...
<?php echo $__env->make('_layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/staging.mediamonitor.it/laravel/Modules/Media/docs/source/index.blade.php ENDPATH**/ ?>